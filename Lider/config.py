...
LIDER_STORES = {
    ...
    'query_stores_prod': "select value from ctrl.scrapers_activation where retail = 'Lider' and data_type = 'Store' and activate= true",
...
LIDER_PRODUCT_LIST = {
    ...
    'query_category_prod':"select value from ctrl.scrapers_activation where retail = 'Lider' and data_type = 'Category' and activate= true",
