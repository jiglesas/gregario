...
for categoria in categorias:
    ...
    if(categoria['href']) == '/':
        ...
        for product in products:
            print(product['href'])
            #print(product.text)
            category_jumbo = {'category_url': product['href'], 'category_name': product.text}
            result.append(category_jumbo)
    ...
    #captura las demas categorias
        ...
        category_jumbo = {'category_url': categoria['href'], 'category_name': categoria.text}
        result.append(category_jumbo)
